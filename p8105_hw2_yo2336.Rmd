...
baby_name_df =
  ...
  mutate(ethnicity = str_replace_all(ethnicity, c("ASIAN" = "ASIAN AND PACIFIC ISLANDER", 
...
knitr::kable(baby_name_tbl, caption = "Rank in Popularity for Baby's Name Olivia")
